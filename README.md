...
states the essential safe-use contract for clients without harness assets:
...
Upgrade and rollback behavior for schema/tool-contract changes is documented in
[MIGRATION.md](MIGRATION.md). Markdown remains authoritative; KB volumes are
